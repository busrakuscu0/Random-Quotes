...
function FieldSet({ className = "", ...props }) {
  return (
    <fieldset
      data-slot="field-set"
      className={cn(
        "flex flex-col gap-4 md:gap-6 has-[>[data-slot=checkbox-group]]:gap-3 has-[>[data-slot=radio-group]]:gap-3",
        className,
      )}
      {...props}
    />
...
function FieldGroup({ className = "", ...props }) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-5 md:gap-7 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4",
        className,
      )}
      {...props}
    />
...
const fieldVariants = cva(
  "group/field flex w-full gap-2 md:gap-3 data-[invalid=true]:text-destructive",
  {
    variants: {
      orientation: {
